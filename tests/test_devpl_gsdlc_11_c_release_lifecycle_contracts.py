...
def test_11c_current_state_rebound_and_full_budget_zero():
    s=json.loads((ROOT/'.devpilot/project_state.json').read_text()); assert s['current_repo'].startswith('repo_DevPilot_Local_422_'); assert s['current_micro_sprint']=='DEVPL-GSDLC-11-C'; assert s['gsdlc_11_full_regression_budget_consumed']==0; assert s['gsdlc_11_c_full_regression_runs']==0
