...
def test_post_h_014_a_contract_validator_blocks_no_unregistered_or_unsafe_routes() -> None:
    ...
    assert summary["routes_total"] == 42
    assert summary["fastapi_route_keys_total"] == 42
    assert summary["canonical_router_route_keys_total"] == 42
    ...
    assert summary["application_service_routes_total"] == 38
