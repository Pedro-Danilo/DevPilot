...
def test_gsdlc_00_b_project_state_advances_program_only_and_preserves_pilot_pause() -> None:
    ...
    assert state["gsdlc_program_status"] == "active/00-b"
    assert state["gsdlc_current_micro_sprint"] == "DEVPL-GSDLC-00-B"
    assert state["gsdlc_next_micro_sprint"] == "DEVPL-GSDLC-00-C"
