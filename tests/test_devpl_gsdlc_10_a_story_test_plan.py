...
def test_10_activation_binding_is_current_10_a_and_full_budget_zero() -> None:
    ...
    assert state["gsdlc_current_micro_sprint"] == "DEVPL-GSDLC-10-A"
    assert state["gsdlc_10_status"].startswith("APPROVED/ACTIVE/GSDLC-10-A")
