...
def test_post_h_019_backlog_is_approved_and_tracks_micro_sprint() -> None:
    ...
    assert backlog_fm["current_micro_sprint"] == "POST-H-019-A"
    assert backlog_fm["next_micro_sprint"] == "POST-H-019-B"
    ...
    assert state["current_micro_sprint"] == "POST-H-019-A"
    assert state["next_micro_sprint"] == "POST-H-019-B"
