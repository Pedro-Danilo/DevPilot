...
def test_sprint_35_readme_runbook_and_phase_c_backlog_are_synchronized() -> None:
    ...
    assert "Último hito: `FUNC-SPRINT-35" in readme
    assert "Siguiente hito: `FUNC-SPRINT-36" in readme
    ...
    assert 'first_open_sprint: "FUNC-SPRINT-36"' in backlog
...
def test_sprint_35_functional_backlog_points_to_sprint_36_without_overclaiming() -> None:
    ...
    assert 'next_sprint: "FUNC-SPRINT-36"' in functional_backlog
