...
def test_sprint_38_readme_runbook_backlog_and_test_strategy_are_synchronized() -> None:
    ...
    assert "Último hito: `FUNC-SPRINT-38" in readme
    assert "Siguiente hito: `FUNC-SPRINT-39" in readme
    ...
    assert 'first_open_sprint: "FUNC-SPRINT-39"' in backlog
    assert 'last_completed_sprint: "FUNC-SPRINT-38"' in backlog
...
def test_sprint_38_functional_backlog_points_to_sprint_39_without_overclaiming() -> None:
    ...
    assert 'next_sprint: "FUNC-SPRINT-39"' in functional_backlog
