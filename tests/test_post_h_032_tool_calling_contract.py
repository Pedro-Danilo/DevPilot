...
def test_post_h_032_f_governance_artifacts_registered() -> None:
    ...
    assert state["post_h_032_current_micro_sprint"] in {"POST-H-032-F", "POST-H-032-G", "POST-H-032-H"}
    assert state["post_h_032_next_micro_sprint"] in {"POST-H-032-G", "POST-H-032-H", "POST-H-033-A"}
