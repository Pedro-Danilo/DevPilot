...
def test_project_global_state_schema_and_docs_are_synchronized() -> None:
    ...
    assert state.get("current_micro_sprint") == state.get("post_h_eval_002_current_micro_sprint")
    assert state.get("next_micro_sprint") == state.get("post_h_eval_002_next_micro_sprint")
