...
def test_project_global_state_schema_and_docs_are_synchronized() -> None:
    ...
    assert state.get("current_micro_sprint") in {"POST-H-033-D", "POST-H-033-E", "POST-H-033-F"}
    assert state.get("next_micro_sprint") in {"POST-H-033-E", "POST-H-033-F", "POST-H-033-CLOSURE"}
    assert state.get("source_repo") == "repo_DevPilot_Local_263_POST_H_025.zip"
    assert state.get("current_repo") in {"repo_DevPilot_Local_305_POST_H_033_D.zip", "repo_DevPilot_Local_306_POST_H_033_E.zip", "repo_DevPilot_Local_307_POST_H_033_F.zip"}
...
def test_post_h_033_e_project_state_adds_policy_guard_pattern_catalogs() -> None:
    ...
    assert state["post_h_033_status"] in {"active/policy-guard-pattern-catalogs-implemented-initial", "active/docs-governance-rule-registry-implemented-initial"}
...
def test_post_h_033_f_project_state_adds_docs_governance_rule_registry() -> None:
    ...
    assert state["post_h_033_status"] == "active/docs-governance-rule-registry-implemented-initial"
