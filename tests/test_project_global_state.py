...
def test_project_global_state_schema_and_docs_are_synchronized() -> None:
    ...
    assert state.get("current_micro_sprint") in {"POST-H-033-D", "POST-H-033-E", "POST-H-033-F", "POST-H-034-A", "POST-H-034-B", "POST-H-034-C", "POST-H-034-D", "POST-H-034-E", "POST-H-034-CLOSURE", "POST-H-EVAL-002-01-A", "POST-H-EVAL-002-01-B", "POST-H-EVAL-002-01-C", "POST-H-EVAL-002-01-D"}
    assert state.get("next_micro_sprint") in {"POST-H-033-E", "POST-H-033-F", "POST-H-033-CLOSURE", "POST-H-034-B", "POST-H-034-C", "POST-H-034-D", "POST-H-034-E", "POST-H-034-CLOSURE", "POST-H-EVAL-002-01-B", "POST-H-EVAL-002-01-C", "POST-H-EVAL-002-01-D"}
    ...
    assert state.get("current_repo") in {"repo_DevPilot_Local_319_POST_H_EVAL_002_01_A.zip", "repo_DevPilot_Local_320_POST_H_EVAL_002_01_B.zip"}
    assert state.get("current_micro_sprint") in {"POST-H-EVAL-002-01-B", "POST-H-EVAL-002-01-C"}
    assert state.get("next_micro_sprint") in {"POST-H-EVAL-002-01-C", "POST-H-EVAL-002-01-D"}
    ...
    assert state["current_micro_sprint"] in {"POST-H-033-D", "POST-H-033-E", "POST-H-033-F", "POST-H-034-A", "POST-H-034-B", "POST-H-034-C", "POST-H-034-D", "POST-H-034-E", "POST-H-034-CLOSURE", "POST-H-EVAL-002-01-A", "POST-H-EVAL-002-01-B", "POST-H-EVAL-002-01-C", "POST-H-EVAL-002-01-D"}
    assert state["next_micro_sprint"] in {"POST-H-033-E", "POST-H-033-F", "POST-H-033-CLOSURE", "POST-H-034-B", "POST-H-034-C", "POST-H-034-D", "POST-H-034-E", "POST-H-034-CLOSURE", "POST-H-EVAL-002-01-B", "POST-H-EVAL-002-01-C", "POST-H-EVAL-002-01-D"}
    assert state.get("post_h_029_test_impact_rule_registry_valid") is True
    assert state.get("post_h_029_test_impact_rules_unknown_impact_escalates") is True
    assert state.get("post_h_029_test_impact_rules_unsafe_commands_total") == 0
