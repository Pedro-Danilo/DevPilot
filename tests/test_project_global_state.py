...
def test_project_global_state_schema_and_docs_are_synchronized() -> None:
    ...
    assert state.get("current_micro_sprint") == "POST-H-033-C"
    assert state.get("next_micro_sprint") == "POST-H-033-D"
    assert state.get("source_repo") == "repo_DevPilot_Local_263_POST_H_025.zip"
    assert state.get("current_repo") == "repo_DevPilot_Local_304_POST_H_033_C.zip"
