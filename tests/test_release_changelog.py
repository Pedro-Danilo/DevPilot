...
def test_release_changelog_builder_generates_keep_a_changelog_sections() -> None:
    ...
    assert changelog["to_sprint"] == "FUNC-SPRINT-99"
    ...
    assert "docs/functional_sprint_93_manifest.json" in markdown
    assert "docs/functional_sprint_94_manifest.json" in markdown
    assert "docs/functional_sprint_95_manifest.json" in markdown
    assert "docs/functional_sprint_96_manifest.json" in markdown
    assert "docs/functional_sprint_97_manifest.json" in markdown
    assert "docs/functional_sprint_98_manifest.json" in markdown
    assert "docs/functional_sprint_99_manifest.json" in markdown
