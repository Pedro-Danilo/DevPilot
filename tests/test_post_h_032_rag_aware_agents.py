...
def test_post_h_032_d_tcr_v1_v2_and_project_state_are_synchronized() -> None:
    ...
    assert state["next_micro_sprint"] in {"POST-H-032-E", "POST-H-032-F", "POST-H-032-G", "POST-H-032-H"}
    assert state["current_repo"] in {"repo_DevPilot_Local_297_POST_H_032_D.zip", "repo_DevPilot_Local_298_POST_H_032_E.zip", "repo_DevPilot_Local_299_POST_H_032_F.zip", "repo_DevPilot_Local_300_POST_H_032_G.zip"}
    assert state["post_h_032_status"] in {"active/rag-aware-agents-implemented-initial", "active/agent-memory-model-implemented-initial", "active/tool-calling-contract-implemented-initial", "active/mcp-fake-server-evaluation-implemented-initial"}
    assert state["post_h_032_current_micro_sprint"] in {"POST-H-032-D", "POST-H-032-E", "POST-H-032-F", "POST-H-032-G", "POST-H-032-H"}
    assert state["post_h_032_next_micro_sprint"] in {"POST-H-032-E", "POST-H-032-F", "POST-H-032-G", "POST-H-032-H"}
