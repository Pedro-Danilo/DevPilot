...
def test_post_h_032_d_tcr_v1_v2_and_project_state_are_synchronized() -> None:
    ...
    assert state["current_repo"] == "repo_DevPilot_Local_297_POST_H_032_D.zip"
    assert state["post_h_032_status"] == "active/rag-aware-agents-implemented-initial"
    assert state["post_h_032_current_micro_sprint"] == "POST-H-032-D"
    assert state["post_h_032_next_micro_sprint"] == "POST-H-032-E"
