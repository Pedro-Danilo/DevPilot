...
def test_sprint_85_advanced_architecture_artifacts_exist_and_are_synchronized() -> None:
    ...
    assert 'source_repo: "repo_DevPilot_Local_116.zip"' in backlog_h
    assert 'last_completed_sprint: "FUNC-SPRINT-90"' in backlog_h
    assert 'next_sprint: "FUNC-SPRINT-91"' in backlog_h
