...
def test_runtime_state_inventory_schema_accepts_minimal_read_only_payload() -> None:
    payload = {
        ...
        "summary": {
            ...
            "status": "implemented-initial",
            "artifacts_total": 0,
            "runtime_artifacts_total": 0,
            "source_of_truth_artifacts_total": 0,
            "versioned_runtime_artifacts_total": 0,
            "sensitive_runtime_artifacts_total": 0,
            "classes_total": 13,
            "classes_with_artifacts_total": 0,
            "git_metadata_available": False,
            "git_tracked_paths_total": 0,
            "clean_zip_must_exclude_total": 9,
