...
def test_sprint_36_readme_runbook_and_phase_c_backlog_are_synchronized() -> None:
    ...
    assert "Último hito: `FUNC-SPRINT-39" in readme
    assert "Siguiente hito: `FUNC-SPRINT-40" in readme
    ...
    assert 'first_open_sprint: "FUNC-SPRINT-40"' in backlog
    assert 'last_completed_sprint: "FUNC-SPRINT-39"' in backlog
...
def test_sprint_36_functional_backlog_points_to_sprint_37_without_overclaiming() -> None:
    ...
    assert 'next_sprint: "FUNC-SPRINT-40"' in functional_backlog
