...
def test_post_h_034_a_project_state_and_claims_remain_blocked() -> None:
    ...
    assert state["post_h_034_current_micro_sprint"] in {"POST-H-034-A", "POST-H-034-B", "POST-H-034-C", "POST-H-034-D", "POST-H-034-E", "POST-H-034-CLOSURE"}
    assert state["post_h_034_next_micro_sprint"] in {"POST-H-034-B", "POST-H-034-C", "POST-H-034-D", "POST-H-034-E", "POST-H-034-CLOSURE"}
...
def test_post_h_034_a_governance_artifacts_are_synchronized() -> None:
    ...
    assert (
        'current_micro_sprint: "POST-H-034-A"' in backlog
        or 'current_micro_sprint: "POST-H-034-B"' in backlog
