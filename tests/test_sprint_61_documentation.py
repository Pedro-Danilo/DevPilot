...
def test_sprint_61_artifacts_exist_and_are_synchronized() -> None:
    ...
    assert 'first_open_sprint: "FUNC-SPRINT-63"' in backlog
    assert 'last_completed_sprint: "FUNC-SPRINT-62"' in backlog
    assert 'next_sprint: "FUNC-SPRINT-63"' in backlog
    assert "## Estado de implementación Sprint 62" in backlog
    assert 'next_sprint: "FUNC-SPRINT-63"' in functional_backlog
    assert "## Transición posterior a FUNC-SPRINT-62" in functional_backlog
