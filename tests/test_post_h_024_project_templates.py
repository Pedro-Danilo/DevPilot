...
def test_post_h_024_documents_and_global_state_advance_to_b_only() -> None:
    ...
    assert state["post_h_024_current_micro_sprint"] == "POST-H-024-B"
    assert state["post_h_024_next_micro_sprint"] == "POST-H-024-C"
    ...
    assert state["post_h_024_project_bootstrap_report_available"] is False
    ...
    assert "Siguiente micro-sprint: `POST-H-024-C — Bootstrap workflow dry-run`" in readme
