...
def test_current_authority_rebound_to_d():
    ...
    assert state["current_micro_sprint"] in {"DEVPL-UX-P0-D", "DEVPL-UX-P0-E", "DEVPL-GSDLC-13-A"}
    assert state["next_micro_sprint"] == ({"DEVPL-UX-P0-D":"DEVPL-UX-P0-E","DEVPL-UX-P0-E":"DEVPL-GSDLC-13","DEVPL-GSDLC-13-A":"DEVPL-GSDLC-13-B"}[state["current_micro_sprint"]])
