...
def test_project_state_and_global_docs_point_to_post_h_024_a() -> None:
    ...
    for text in (readme, runbook):
        ...
        assert "Siguiente micro-sprint: `POST-H-024-D — Onboarding validation y readiness preview`" in text or "Siguiente micro-sprint: `POST-H-024-C — Bootstrap workflow dry-run`" in text or "Siguiente micro-sprint: `POST-H-024-B — Templates de proyecto nuevo`" in text
