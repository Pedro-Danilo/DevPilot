...
def test_sprint_43_readme_runbook_backlog_and_test_strategy_are_synchronized() -> None:
    ...
    assert 'first_open_sprint: "FUNC-SPRINT-44"' in backlog
    assert 'last_completed_sprint: "FUNC-SPRINT-43"' in backlog
    assert "Estado de implementación Sprint 43" in backlog
    assert 'next_sprint: "FUNC-SPRINT-44"' in functional_backlog
