...
def test_phase_h_backlog_is_approved_after_phase_g_closure() -> None:
    ...
    assert 'version: "1.0.0"' in backlog_h
    assert 'source_repo: "repo_DevPilot_Local_107.zip"' in backlog_h
    assert 'phase_h_status: "approved_for_implementation"' in backlog_h
    assert 'next_sprint: "FUNC-SPRINT-85"' in backlog_h
