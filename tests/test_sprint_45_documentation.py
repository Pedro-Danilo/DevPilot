...
def test_sprint_45_readme_runbook_backlogs_and_test_strategy_are_synchronized() -> None:
    ...
    assert 'first_open_sprint: "FUNC-SPRINT-46"' in backlog_d
    assert 'last_completed_sprint: "FUNC-SPRINT-45"' in backlog_d
...
def test_sprint_45_miasi_model_provider_policy_declared() -> None:
    ...
    assert tools["model.call.local"]["status"] == "planned"
