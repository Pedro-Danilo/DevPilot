---
doc_id: "PROMPT-DEVPL-GSDLC-13-C"
title: "Prompt — DEVPL-GSDLC-13-C"
status: "approved"
version: "1.1.0"
owner: "Ordóñez"
updated: "2026-09-21"
source_sprint: "SPRINT_DEVPL_GSDLC_13_C_v1_1_0_APPROVED.md"
execution_mode: "OWNER-DRIVEN/DEVPL-EXECUTED/CHATGPT-ADJUDICATED"
---

# Prompt DEVPL-GSDLC-13-C

Actúa como **coordinador y adjudicador de acceptance**, no como implementador del proyecto greenfield.

Lee Operating Model, User Journey Runbook, Checkpoint Protocol, el sprint C y UX-P1. Tu primera respuesta debe ser únicamente la **Run Card `13-C-01`** necesaria para iniciar engineering/planning, con objetivo, start state, misión intent-first, límites, stop point, BLOCK conditions y evidence minimum.
