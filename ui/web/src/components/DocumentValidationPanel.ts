...
export function createDocumentValidationPanel(options: DocumentValidationPanelOptions): HTMLElement {
  ...
  function draw(): void {
    ...
    planButton.className = 'validation-action-button';
    ...
    executeButton.className = 'validation-action-button';
    ...
    refreshButton.className = 'validation-action-button traceability-refresh-button';
