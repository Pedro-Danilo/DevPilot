...
export class DevPilotApiClient {
  ...
  async preCodeDraft(stageId: string, payload: { mode: 'MANUAL' | 'IMPORT' | 'DEVPL_MOCK'; content: string; semantic_model?: import('./types').PreCodeSemanticModel | null }): Promise<DevPilotApplicationResponse> {
  ...
  async backlogStatus(): Promise<DevPilotApplicationResponse<import('./types').BacklogWorkbenchResponseData>> { return this.get('/planning/backlog', { retryNetworkErrors: true, timeoutMs: READINESS_REQUEST_TIMEOUT_MS }) as unknown as Promise<DevPilotApplicationResponse<import('./types').BacklogWorkbenchResponseData>>; }
  async backlogPropose(payload: import('./types').BacklogProposalRequest): Promise<DevPilotApplicationResponse<import('./types').BacklogWorkbenchResponseData>> { return this.post('/planning/backlog/proposals', payload, { timeoutMs: READINESS_REQUEST_TIMEOUT_MS }) as unknown as Promise<DevPilotApplicationResponse<import('./types').BacklogWorkbenchResponseData>>; }
  async backlogReview(): Promise<DevPilotApplicationResponse<import('./types').BacklogWorkbenchResponseData>> { return this.post('/planning/backlog/review', {}, { timeoutMs: READINESS_REQUEST_TIMEOUT_MS }) as unknown as Promise<DevPilotApplicationResponse<import('./types').BacklogWorkbenchResponseData>>; }
  async backlogApprove(): Promise<DevPilotApplicationResponse<import('./types').BacklogWorkbenchResponseData>> { return this.post('/planning/backlog/approve', {}, { timeoutMs: READINESS_REQUEST_TIMEOUT_MS }) as unknown as Promise<DevPilotApplicationResponse<import('./types').BacklogWorkbenchResponseData>>; }
  async backlogFreeze(): Promise<DevPilotApplicationResponse<import('./types').BacklogWorkbenchResponseData>> { return this.post('/planning/backlog/freeze', {}, { timeoutMs: READINESS_REQUEST_TIMEOUT_MS }) as unknown as Promise<DevPilotApplicationResponse<import('./types').BacklogWorkbenchResponseData>>; }
  async sprintStatus(): Promise<DevPilotApplicationResponse<import('./types').SprintPlannerResponseData>> { return this.get('/planning/sprint', { retryNetworkErrors: true, timeoutMs: READINESS_REQUEST_TIMEOUT_MS }) as unknown as Promise<DevPilotApplicationResponse<import('./types').SprintPlannerResponseData>>; }
  async sprintPropose(payload: import('./types').SprintProposalRequest): Promise<DevPilotApplicationResponse<import('./types').SprintPlannerResponseData>> { return this.post('/planning/sprint/proposals', payload, { timeoutMs: READINESS_REQUEST_TIMEOUT_MS }) as unknown as Promise<DevPilotApplicationResponse<import('./types').SprintPlannerResponseData>>; }
  async sprintReview(): Promise<DevPilotApplicationResponse<import('./types').SprintPlannerResponseData>> { return this.post('/planning/sprint/review', {}, { timeoutMs: READINESS_REQUEST_TIMEOUT_MS }) as unknown as Promise<DevPilotApplicationResponse<import('./types').SprintPlannerResponseData>>; }
  async sprintApprove(): Promise<DevPilotApplicationResponse<import('./types').SprintPlannerResponseData>> { return this.post('/planning/sprint/approve', {}, { timeoutMs: READINESS_REQUEST_TIMEOUT_MS }) as unknown as Promise<DevPilotApplicationResponse<import('./types').SprintPlannerResponseData>>; }
  ...
  async storyTestPlanCreate(planId:string, planHash:string): Promise<DevPilotApplicationResponse> { return this.post(`/story/code/change-plans/${encodeURIComponent(planId)}/test-plan`, {plan_hash:planHash}); }
  async storyTestPlan(testPlanId:string): Promise<DevPilotApplicationResponse> { return this.get(`/story/code/test-plans/${encodeURIComponent(testPlanId)}`); }
  async storyTestPlanDecision(testPlanId:string, payload:{test_plan_hash:string;decision:'APPROVE'|'REJECT'|'WAIVE';reason?:string|null;waived_test_ids?:string[];ttl_minutes?:number}): Promise<DevPilotApplicationResponse> { return this.post(`/story/code/test-plans/${encodeURIComponent(testPlanId)}/decision`, payload); }
  ...
  async releasePackageStatus(): Promise<DevPilotApplicationResponse<{ release_package: import('./types').ReleasePackageResult | { state: string } }>> {
    return this.get('/release/package', { timeoutMs: REPORTS_REQUEST_TIMEOUT_MS, retryNetworkErrors: true }) as Promise<DevPilotApplicationResponse<{ release_package: import('./types').ReleasePackageResult | { state: string } }>>;
  }

  async releasePackagePlan(): Promise<DevPilotApplicationResponse<{ plan: import('./types').ReleasePackagePlan }>> {
    return this.post('/release/package/plan', { dry_run: true }, { timeoutMs: REPORTS_REQUEST_TIMEOUT_MS }) as Promise<DevPilotApplicationResponse<{ plan: import('./types').ReleasePackagePlan }>>;
  }
