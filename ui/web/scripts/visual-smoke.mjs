...
const expectedRoutes = ['ui.dashboard', 'ui.reports', 'ui.traces', 'ui.approvals', 'ui.settings', 'ui.workspace-documents', 'ui.jobs', 'ui.quality', 'ui.ai'];
...
const visualMarkers = [
  ...
  ['ai console', 'src/pages/AiOperationsView.ts', ['IA / RAG gobernados', 'ui.ai', 'Mock obligatorio', 'insufficient-evidence', 'Memoria local opt-in']],
