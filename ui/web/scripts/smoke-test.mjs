...
const aiView = read('src/pages/AiOperationsView.ts');
...
const filesToScan = [client, dashboard, statusCard, reportsView, tracesView, findingTable, approvalCenterView, dryRunActionForm, settingsView, providerSettings, jobsView, qualityView, aiView, contractBadges, sanitizeUtils, operatorDashboard, operatorStatusCard, operatorGatePanel, operatorNextActions, workspaceDocumentsView, documentTree, documentViewer, documentValidationPanel, read('src/main.ts')];
...
const expectedUiRoutes = ['ui.dashboard', 'ui.reports', 'ui.traces', 'ui.approvals', 'ui.settings', 'ui.workspace-documents', 'ui.jobs', 'ui.quality', 'ui.ai'];
