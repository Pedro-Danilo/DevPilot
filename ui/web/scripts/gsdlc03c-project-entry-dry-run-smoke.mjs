...
for(const marker of ['CREATE_NEW','OPEN_EXISTING','IMPORT_GIT','Generar dry-run','Revalidar preimage'])check(view.includes(marker),`view:${marker}`);
check(view.includes('Ejecución deshabilitada')||view.includes('Fail-closed: execute requiere'),'view:execution-fail-closed-successor-aware');
