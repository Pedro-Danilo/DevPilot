...
const required=[
  ...
  ['decision-inbox-after-draft',view.includes("stage.status!=='MISSING'")&&view.includes("review.disabled=stage.status==='MISSING' || Boolean(inbox)")],
  ['decision-sequencing',view.includes("save.disabled=true")&&view.includes('Primero guarda las decisiones pendientes y revisa el DRAFT regenerado.')],
  ['semantic-error-persistent',view.includes("setFeedback(feedback,'block',formatFindings(r)); return;")],
  ['governed-regenerate',view.includes('Regenerar propuesta desde decisiones guardadas')&&view.includes('DRAFT regenerado desde las decisiones guardadas')&&view.includes("content:'',semantic_model:null")],
