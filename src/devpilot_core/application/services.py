...
def _capabilities() -> list[ServiceCapability]:
    rows = [
        ...
        ("guided_sdlc.pre_code.draft", "Persist one current-stage MANUAL/IMPORT/DEVPL_MOCK DRAFT in platform runtime state without managed source write.", "runtime_draft_only", False, "POST /api/v1/guided-sdlc/pre-code/stages/{stage_id}/draft"),
