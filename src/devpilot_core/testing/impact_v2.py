...
_RULES = (
    ...
    _HeuristicRule(
        ...
        commands=(
            "python -m pytest tests/test_release_manifest.py tests/test_release_sbom.py tests/test_release_verification.py tests/test_package_builder.py tests/test_post_h_027_source_zip_policy.py tests/test_post_h_027_python_artifact_install_verification.py tests/test_post_h_027_artifact_manifest_checksums.py -q",
