...
_RULES = (
    ...
    _HeuristicRule(
        ...
        commands=(
            "python -m pytest tests/test_release_manifest.py tests/test_release_sbom.py tests/test_release_verification.py tests/test_package_builder.py tests/test_post_h_027_source_zip_policy.py tests/test_post_h_027_python_artifact_install_verification.py tests/test_post_h_027_artifact_manifest_checksums.py tests/test_post_h_027_windows_install_smoke.py tests/test_post_h_027_upgrade_rollback_dry_run.py -q",
            "python -m devpilot_core package source-zip-policy --json",
            "python -m devpilot_core release python-artifact-verify --artifact dist/devpilot_local-0.1.0-py3-none-any.whl --json",
            "python -m devpilot_core release artifact-manifest --version 0.1.0 --verify-checksums --json",
            "python -m devpilot_core install windows-smoke --mode editable --json",
