...
class QualityGate:
    ...
    def _operator_flow_smoke(self) -> CommandResult:
    ...
    def _production_ready_claims_validator(self) -> CommandResult:
        from devpilot_core.industrial.production_ready import ProductionReadyClaimsValidator

        return ProductionReadyClaimsValidator(self.root).validate()
