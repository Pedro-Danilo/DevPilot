...
ARTIFACT_PROFILES: tuple[ArtifactProfile, ...] = (
    ...
    ArtifactProfile(
        ...
        required_headings=("resumen ejecutivo", "justificación", "beneficios", "riesgos"),
        recommended_headings=("costos", "retorno", "criterios"),
    ),
    ArtifactProfile(
        id="mvp-scope",
        ...
        required_headings=("mvp", "mvp+", "fuera de alcance", "criterios"),
        recommended_headings=("post-mvp", "restricciones", "supuestos"),
    ),
    ArtifactProfile(
    ...
    ArtifactProfile(
        ...
        required_headings=("propósito", "trazabilidad"),
    ...
    ArtifactProfile(
        ...
        required_headings=("propósito", "alcance", "logs", "trazas", "métricas"),
    ...
    ArtifactProfile(
        ...
        required_headings=("propósito", "herramientas", "permisos", "criterios pass", "criterios block"),
        recommended_headings=("side effects", "dry-run", "aprobación"),
    ),
    ArtifactProfile(
        ...
        required_headings=("propósito", "políticas", "dry-run", "aprobación", "criterios block"),
        recommended_headings=("costguard", "secretguard", "policy engine"),
    ),
    ArtifactProfile(
        id="miasi-eval-card",
        ...
        recommended_headings=("datasets", "agentic", "trazabilidad"),
    ),
    ArtifactProfile(
        ...
        recommended_headings=("dry-run", "policy", "auditoría"),
    ),
    ArtifactProfile(
        ...
        required_headings=("propósito", "observabilidad", "eventos", "trazas", "criterios"),
        recommended_headings=("agentops", "opentelemetry", "costos"),
    ),
)
