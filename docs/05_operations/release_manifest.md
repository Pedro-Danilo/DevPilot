...
- Checksums, smoke test y release verification: Sprint 81 (`outputs/reports/checksums.sha256`, `outputs/reports/release_smoke_test.*`, `outputs/reports/release_verification.*`, implemented-initial).
...
Desde `FUNC-SPRINT-79`, el Release Manifest reconoce como `implemented-initial` los artefactos de packaging local:

- `PKG-CLEAN-ZIP`: `dist/release/devpilot-local-<version>-source.zip`.
- `PKG-WHEEL`: `dist/devpilot_local-<version>-py3-none-any.whl`.
