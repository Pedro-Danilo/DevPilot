---
title: "Checklist — CI/CD agéntico"
version: "1.0.0"
status: "approved"
owner: "AI_agents"
updated: "2026-05-31"
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| CI-001 | Tests unitarios/integración PASS | Obligatorio | pytest report | QA | Suite PASS | Fallos abiertos | 14 |
| CI-002 | Agent evals PASS | Obligatorio | eval report | Eval Owner | Thresholds cumplidos | Evals fallan | 14 |
| CI-003 | Security gates PASS | Obligatorio | secret/SAST/SBOM reports | Security Reviewer | Sin bloqueantes | Críticos abiertos | 14 |
| CI-004 | Policy tests PASS | Obligatorio | policy tests | Security Reviewer | Allow/block correcto | Default unsafe | 14 |
| CI-005 | Artefactos versionados | Obligatorio | release artifacts | Release Manager | Commit/release identificable | Artefactos sueltos | 14 |
| CI-006 | Workflows sin secretos embebidos | Obligatorio | workflow scan | Security Reviewer | No tokens | Secretos en YAML | LAB-AI-079 |
| CI-007 | Ambiente sandbox/staging | Obligatorio antes de prod | deployment card | Release Manager | No afecta producción | Prueba en prod | 15 |
| CI-008 | Rollback definido | Obligatorio | deployment card/runbook | SRE | Rollback practicable | Sin rollback | 15 |
