---
title: "Checklist — readiness de evaluación"
version: "1.0.0"
status: "approved"
owner: "AI_agents"
updated: "2026-05-31"
...
---
# Checklist — readiness de evaluación
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| ER-001 | Eval Card existe | Obligatorio | eval_card.md | Eval Owner | Métricas y dataset | Sin Eval Card | 04 |
| ER-002 | Dataset versionado | Obligatorio | fixtures/evals | Eval Owner | Casos reproducibles | Casos manuales no trazados | 03 |
| ER-003 | Métricas alineadas a riesgo | Obligatorio | metrics | Architect/Eval | Mide task/tool/policy | Solo mide texto bonito | 04 |
| ER-004 | Thresholds definidos | Obligatorio | thresholds | Eval Owner | PASS/FAIL claro | Sin umbrales | 04 |
| ER-005 | Regresión automatizada | Obligatorio | CI job/test | QA | Corre en CI/local | No detecta regresión | 03,04 |
| ER-006 | Policy compliance bloqueante | Obligatorio | policy metric | Security Reviewer | Fallo bloquea | Policy solo warning | 04 |
| ER-007 | Casos adversarios | Obligatorio si riesgo medio+ | adversarial cases | Security/Eval | Incluye prompt injection/tool misuse | Solo happy path | OWASP |
| ER-008 | Resultados trazables | Obligatorio | eval report/traces | AgentOps | run_id/eval_id asociados | Resultados sin trazas | 04 |
...
```yaml
checklist_id: checklist_eval_readiness
