...
---
  ...
  - "post_release_checks"
    ...
    Planificar versión, alcance, evidencias, riesgos, comunicación y rollback.
    ...
    |---|---|---|
    | `version` | Debe documentarse de forma clara, verificable y trazable. | No puede quedar vacío ni ambiguo. |\n    | `scope` | Debe documentarse de forma clara, verificable y trazable. | No puede quedar vacío ni ambiguo. |\n    | `included_changes` | Debe documentarse de forma clara, verificable y trazable. | No puede quedar vacío ni ambiguo. |\n    | `quality_evidence` | Debe documentarse de forma clara, verificable y trazable. | No puede quedar vacío ni ambiguo. |\n    | `risk_summary` | Debe documentarse de forma clara, verificable y trazable. | No puede quedar vacío ni ambiguo. |\n    | `rollback_plan` | Debe documentarse de forma clara, verificable y trazable. | No puede quedar vacío ni ambiguo. |\n    | `approval` | Debe documentarse de forma clara, verificable y trazable. | No puede quedar vacío ni ambiguo. |\n

    ## 4. Campos opcionales

    | Campo | Uso recomendado |
    |---|---|
    | `migration_notes` | Usar cuando aporte contexto, riesgo, trazabilidad o decisión. |\n    | `release_notes` | Usar cuando aporte contexto, riesgo, trazabilidad o decisión. |\n    | `post_release_checks` | Usar cuando aporte contexto, riesgo, trazabilidad o decisión. |\n
  ...
  "risk_summary": "low",
  "rollback_plan": "restore previous tag",
