...
```text
1. [x] Crear production_ready_local_criteria.schema.json.
2. [x] Crear production_ready_local_report.schema.json.
3. [x] Crear criteria JSON bajo .devpilot/production/.
4. [x] Mapear cada hito requerido a evidencia esperada.
5. [x] Clasificar evidencia: required, optional, blocker, advisory.
```
