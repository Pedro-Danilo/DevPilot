...
doc_id: MIPS-TPL-SUPPLY_CHAIN_REPORT
doc_type: template
version: 0.1.0
status: draft
...
template_id: supply_chain_report
---
...
Reportar el estado de dependencias, artefactos, provenance, firma, vulnerabilidades, licencias y riesgos de cadena de suministro.
